  ...
  const handleImportExcel = (event) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        const importedProducts = jsonData.map((row: any, index) => ({
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold bg-gradient-primary bg-clip-text text-transparent">InventoryPro</span>
            </div>
              ...
              <div className="max-w-3xl mx-auto bg-card print:shadow-none shadow-card p-8 print:p-0">
                ...
                <div className="flex justify-between items-start mb-8">
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg">InventoryPro</p>
                  </div>
                  <div className="text-right">
