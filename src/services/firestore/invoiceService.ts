...
export const invoiceService = {
  ...
  // Removed _getLatestInvoiceNumber as auto-suggestion is no longer desired.
    ...
    if (invoice.number) {
      ...
      if (invoice.number !== currentInvoiceData.number) {
        ...
        if (!querySnapshot.empty) {
          ...
          if (duplicateInvoice.id !== id && getInvoiceNumberingType(duplicateInvoice.invoiceType) === numberingType && duplicateYearShort === currentYearShort) {
